      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {ageGroups[activeTab].plans.map((plan, index) => (
            <div key={index} className="bg-white p-8 rounded-2xl shadow-sm border hover:shadow-lg transition-shadow">
              ...
              <button className="w-full py-3 bg-[#FF69B4] text-white font-medium rounded-lg hover:opacity-90 transition-opacity">
                詳しく見る
              </button>
            </div>
          ))}
