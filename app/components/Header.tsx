    ...
    <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md border-b border-gray-200 z-50">
      ...
      <div className="bg-blue-50 border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-6 h-9 flex items-center justify-center text-sm">
          <Link href="/seminar-parents-chatgpt" prefetch={false} className="inline-flex items-center gap-2 text-[#0052cc] font-semibold hover:underline">
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2">
            <img src="/brand/logo.png" alt="Shindo Kids logo" className="h-7 w-auto" />
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link href="/#courses" className="text-sm font-semibold text-gray-700 hover:text-[#0073e6] transition-all duration-300 hover:scale-110">
            開催予定セミナー
          </Link>
